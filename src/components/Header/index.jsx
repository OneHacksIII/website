          ...
          <div className="relative -mx-4 flex items-center justify-between">
            ...
            <div className="flex w-full items-center justify-between px-4">
              <div>
                ...
                <nav
                  id="navbarCollapse"
                  className={`navbar absolute right-0 z-30 w-[250px] rounded border-[.5px] border-body-color/20 py-4 px-6 duration-300  bg-dark lg:visible lg:static lg:w-auto lg:border-none lg:!bg-transparent lg:p-0 lg:opacity-100 ${navbarOpen
                    ...
                    {menuData.map((menuItem, index) => (
                      <li key={menuItem.id} className="group relative">
                        {menuItem.path ? (
                          <a
                            href={menuItem.path}
                            className={`flex py-2 text-base  group-hover:opacity-70 text-white lg:mr-0 lg:inline-flex lg:py-6 lg:px-0`}
                          >
                            {menuItem.title}
                          </a>
                        ) : (
                            ...
                            >
                              {menuItem.submenu.map((submenuItem) => (
                                <a
                                  ...
                                  key={submenuItem.id}
                                  className="block rounded py-2.5 text-sm hover:opacity-70 text-white lg:px-3"
                                >
                                  {submenuItem.title}
                                </a>
                              ))}
              ...
              <div className="flex items-center justify-end pr-16 lg:pr-0">
                ...
                <a
                  href="https://forms.gle/3oXRyLXsKfwLN5xL8"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="ease-in-up hidden rounded-md bg-primary py-3 px-8 text-base font-bold text-black transition duration-300 hover:bg-opacity-90 hover:shadow-signUp md:block md:px-9 lg:px-6 xl:px-9"
                >
                  Sign Up
                </a>
                <div>
